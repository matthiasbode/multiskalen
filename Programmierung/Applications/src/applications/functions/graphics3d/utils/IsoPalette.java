 ...
 */
package applications.functions.graphics3d.utils;
...
public class IsoPalette {
    ...
    public enum Palette {
        ...
        GruenBlauBraunGelbWicht(new Color[]{new Color(255, 255, 0), new Color(150, 0, 33), new Color(0, 255, 0), new Color(0, 0, 255),}, true),
        GelbBraunBlauGruenWicht(new Color[]{new Color(0, 0, 255), new Color(0, 255, 0), new Color(150, 0, 33), new Color(255, 255, 0),}, true),
        GruenBlauBraunWicht(new Color[]{new Color(150, 0, 33), new Color(0, 255, 0), new Color(0, 0, 255),}, true),
        BlauRotDiff(new Color[]{new Color(150, 0, 33)}, new Color(0, 255, 0), new Color[]{new Color(0, 0, 255)}, false),
        ...
        SchwarzAlpha(new Color[]{new Color(0, 0, 0, 0), new Color(0, 0, 0, 255)}, false),
        WeissAlphaToHigh(new Color[]{new Color(255, 255, 255, 0), new Color(255, 255, 255, 255)}, false),
        WeissAlphaToLow(new Color[]{new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)}, false),
        SchwarzWeiss(new Color[]{new Color(255, 255, 255), new Color(0, 0, 0)}, false),
        Rainbow(new Color[]{Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN, Color.BLUE, new Color(138, 43, 226), new Color(75, 0, 130)}, false),
        Weiss(new Color[]{new Color(255, 255, 255, 255), new Color(255, 255, 255, 255)}, false),
        WeissTransparent(new Color[]{new Color(255, 255, 255, 100), new Color(255, 255, 255, 100)}, false);
        public Color[] colors;
        public Color[] colmin;
...
//    }
    ...
    public Color getColor(double iso) {
        if (Double.isNaN(iso)) {
            return Color.WHITE;
        }
        ...
        if (i == 0) {
            ...
            int a = a0 + (int) (lambda * (double) (a1 - a0));
...
//        Color[] colmax = new Color[]{new Color(255,0,0)};
        ...
        Color colnull = new Color(0, 255, 0);
...
//                                g.drawString("0" , 5, (int) y);
    ...
    private static final IsoPalette palette = new IsoPalette(-25, 25, Palette.BlauGruen);
