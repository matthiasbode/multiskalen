 ...
 */
public class SimpleCanvas3D_NEU extends Canvas3D {
...
//------------------------------------------------------------------------------//
    /**
     * Extra-Methode f&uuml;r JWalkerS3D
     * @param g
...
//------------------------------------------------------------------------------//
    public void showAxis(float size) {
        if (bg_environment.isLive()) {
            bg_environment.detach();
        }
...
//------------------------------------------------------------------------------//
     ...
     * guckt  und eine Richtung in welche man guckt.
     *
     * @param position  Feld von Punkten von denen aus man guckt
     * @param blickrtg  Feld von Punkten in deren Richtung man guckt
     * @param vec       Normalenverktor der ViewPlatform
     * @param delay     Sleep Time zwischen den einzelnen Schritten
     */
//------------------------------------------------------------------------------//
    public void setViewPoints(Point3d[] position, Point3d[] blickrtg, Vector3d[] vec, long delay) {
        Transform3D tf3 = new Transform3D();

        for (int i = 0; i < blickrtg.length; i++) {
            try {
                Thread.sleep(delay);
            } catch (InterruptedException ex) {
                Logger.getLogger(SimpleCanvas3D_NEU.class.getName()).log(Level.SEVERE, null, ex);
            }
            tf3.lookAt(position[i], blickrtg[i], vec[i]);
            tf3.invert(tf3);
            tg_viewTrafo.setTransform(tf3);
        }
    }
...
//------------------------------------------------------------------------------//
    public static void main(String[] args) {
        ...
        SimpleCanvas3D_NEU canvas = new SimpleCanvas3D_NEU();
        frame.add(canvas);
...
//------------------------------------------------------------------------------//
        ...
        p[0] = new Point3d(2, 0, 0);
        p[4] = new Point3d(2, 10, 0);
        p[1] = new Point3d(1, 0, 0);
        p[5] = new Point3d(1, 10, 0);
        p[2] = new Point3d(1, 0, 100);
        p[6] = new Point3d(1, 10, 100);
        p[3] = new Point3d(2, 0, 100);
        p[7] = new Point3d(2, 10, 100);

        p[8] = new Point3d(7, 0, 0);
        p[12] = new Point3d(7, 10, 0);
        p[9] = new Point3d(6, 0, 0);
        p[13] = new Point3d(6, 10, 0);
        p[10] = new Point3d(6, 0, 100);
        p[14] = new Point3d(6, 10, 100);
        p[11] = new Point3d(7, 0, 100);
        p[15] = new Point3d(7, 10, 100);

        p[16] = new Point3d(4, 0, -100);
        p[20] = new Point3d(9, 0, -100);
        p[17] = new Point3d(5, 0, -100);
        p[21] = new Point3d(10, 0, -100);
        p[18] = new Point3d(5, 10, -100);
        p[22] = new Point3d(10, 10, -100);
        p[19] = new Point3d(4, 10, -100);
        p[23] = new Point3d(9, 10, -100);
...
//        }
    ...
    class MyKeyListener implements KeyListener {
        ...
        private int aaa = 0;
        private SimpleCanvas3D_NEU si;

        public MyKeyListener(SimpleCanvas3D_NEU si) {
            this.si = si;
        }
