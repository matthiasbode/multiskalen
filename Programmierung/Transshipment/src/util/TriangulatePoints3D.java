...
public class TriangulatePoints3D {
    ...
    private IndexedTriangleArray triangles3d;
    ...
    public TriangulatePoints3D(Map<Point3d, Color> map) {
        ...
        this.triangles3d = new IndexedTriangleArray(map.keySet().size(), GeometryArray.COORDINATES | GeometryArray.COLOR_3 | GeometryArray.USE_COORD_INDEX_ONLY, func.getNumberOfTriangles() * 3);
    ...
    public static void main(String[] args) {
        ...
        Shape3D shape = new Shape3D(t.getGeometry());
