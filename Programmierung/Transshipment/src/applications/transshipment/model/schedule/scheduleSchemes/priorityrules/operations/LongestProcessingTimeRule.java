 ...
 * längsten Prozessdauer vorne in der Liste zu finden sind.
 *
 * @author bode
 */
public class LongestProcessingTimeRule<E extends Operation> implements OperationRules<E> {
    ...
    public int compare(E o1, E o2) {
        ...
        return duration1.isGreaterThan(duration2) ? -1 : 1;
    }
