 ...
 * höchsten Anzahl an Nachfahren vorne in der Liste zu finden sind.
 *
 * @author bode
 */
public class MostTotalSuccessorsRule<E extends Operation> implements OperationRules<E> {

    ActivityOnNodeGraph<E> aon;

    @Override
    public int compare(E o1, E o2) {
        int size1 = aon.getDescendats(o1).size();
        int size2 = aon.getDescendats(o2).size();
