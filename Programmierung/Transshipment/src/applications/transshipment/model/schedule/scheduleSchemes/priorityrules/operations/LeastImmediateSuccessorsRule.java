 ...
 * geringsten Anzahl an Nachfolgern vorne in der Liste zu finden sind.
 *
 * @author bode
 */
public class LeastImmediateSuccessorsRule<E extends Operation> implements OperationRules<E> {
