 ...
 * @author bode
 */
public class LehrteTrainGenerator implements TrainGenerator {

    public static int numberOfTrains = 16;
    public static int numberOfWagons = 35;
    public static int numberOfSlots = 3;

    public static long begutachtungsdauer = 20 * 1000 * 60;
    public static long zeitlicherAbstandZwischenZweiZuegen = 20 * 1000 * 60;
    public static long gleisneubelegungsdauer = 15 * 1000 * 60;
    ...
    public List<Train> generateTrains(Terminal terminal, ParameterInputFile parameters) {
        ...
        for (int i = 0; i < numberOfTrains; i++) {
            Train train = new Train(numberOfWagons, LoadUnitTypen.Typ20, LoadUnitTypen.Typ40);
            trains.add(train);
            int anz20feetmax = 0;
            int anz40feetmax = 0;
...
//               if (rec.getWidth() == LoadUnitTypen.Typ40.length) {
        ...
        long abstandeinfahrtzuege = zeitlicherAbstandZwischenZweiZuegen;
        long luecke = gleisneubelegungsdauer + begutachtungsdauer;
