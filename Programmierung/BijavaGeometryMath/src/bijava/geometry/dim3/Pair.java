 ...
 * repraesentiert. Die Klasse <code>Edge</code> beschreibt
 * eine Kante in einem Graphen.
 *
 * Zwei Kanten sind gleich, wenn sie den selben ersten (<code>first</code>)
 * und zweiten (<code>second</code>) Knoten haben.
 */
//==========================================================================//
public class Pair<E1, E2> {
    ...
    /**
     * Erzeugt ein neues geordnetes Paar und füllt es mit den Elementen
     * des zu übergebenen geordneten Paares. Nur die Referenz wird kopiert,
     ...
     *
     *
     *  @return Diese Methode gibt das zweite Element des geordneten Paares zurück*/
    public E2 getSecond() {
        return second;
    }
     ...
     *
     *  <p><IMG SRC="../images/struct/Pair.toString.gif"
     *  vspace=20 hspace=20></p>
     *
     ...
     *                Objekt eine Kante ist und die selben Elemente in der selben
     *                Reihenfolge hat
     */
    @Override
