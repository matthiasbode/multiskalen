...
//==========================================================================//
/**
 * "Function" stellt eine Klasse f&uuml;r elementare mathematische Funktionen
 *  zur Verf&uuml;gung.
 *
 *  @version 1.0, Juli 2000
 *
 *  @author Institut f&uuml;r Bauinformatik
 *  @author Universit&auml;t Hannover
 *  @author Martin Rose
...
public abstract class Function {
    ...
    //  SINUSHYPERBOLIKUS                                                       //
    //--------------------------------------------------------------------------//
    /** Liefert den Sinushyperbolikus einer Gleitpunktzahl.
     *  Der Definitionsbereich liegt zwischen -unendlich und plus unendlich.
     *  Der Wertebereich liegt ebenfalls zwischen -unendlich und plus unendlich.
     *  Die Funktion ist unsymmetrisch.
     *  Sie hat eine Nullstelle bei x = 0.
     *  Die Funktion ist streng monoton wachsend.
     *
     *  <p><IMG SRC="./imagesFunction/sinh.gif" vspace=20 hspace=20>
     *
     *  @param x	Wert, zu dem der Sinushyperbolikus bestimmt werden soll.
     *  @deprecated java.lang.Math.sinh(x) since j2se 1.5 */
    //--------------------------------------------------------------------------//
    ...
    //  COSINUSHYPERBOLIKUS                                                     //
    //--------------------------------------------------------------------------//
    /** Liefert den Cosinushyperbolikus einer Gleitpunktzahl.
     *  Der Definitionsbereich liegt zwischen -unendlich und plus unendlich.
     *  Der Wertebereich liegt zwischen 1 und unendlich.
     *  Die Funktion ist symmetrisch.
     *  Sie hat ein Minimum bei x = 0.
     *
     *  <p><IMG SRC="./imagesFunction/cosh.gif" vspace=20 hspace=20>
     *
     *  @param x	Wert, zu dem der Cosinushyperbolikus bestimmt werden soll.
     *  @deprecated java.lang.Math.cosh(x) since j2se 1.5 */
    //--------------------------------------------------------------------------//
    ...
    //  TANGENSHYPERBOLIKUS                                                     //
    //--------------------------------------------------------------------------//
    /** Liefert den Tangenshyperbolikus einer Gleitpunktzahl.
     *  Der Definitionsbereich liegt zwischen -unendlich und plus unendlich.
     *  Der Wertebereich liegt ebenfalls zwischen -1 und 1.
     *  Die Funktion ist unsymmetrisch.
     *  Sie hat eine Nullstelle bei x = 0.
     *  Die Funktion ist streng monoton wachsend.
     * Sie hat zwei Asymptoten bei y = -1 und y = 1.
     *
     *  <p><IMG SRC="./imagesFunction/tanh.gif" vspace=20 hspace=20>
     *
     *  @param x	Wert, zu dem der Tangenshyperbolikus bestimmt werden soll.
     *  @deprecated java.lang.Math.tanh(x) since j2se 1.5  */
    //--------------------------------------------------------------------------//
    public static double tanh(double x) {
        if (Math.abs(x) < 600.0) {
            double ehx = Math.exp(x);
            double ehmx = Math.exp(-x);
            
            return (ehx - ehmx) / (ehx + ehmx);
        } else {
            return sign(x) * 1.0;
        }
    }
    ...
    /**
     *	Returns sign(value)
     *      @deprecated java.lang.Math.signum(x) since j2se 1.5.
     */
    ...
    /**
     *	Returns sign(value)
     *      @deprecated signum(x) (see expansion in java.lang.Math since j2se 1.5)
     */
...
Direct inquiries to 30 Frost Street, Cambridge, MA 02140
     ...
     */
    public final static double norm(double x, double y){
