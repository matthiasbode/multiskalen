 ...
 * sources (<code>InputStream, Reader,
 ...
 * underlying InputStream, to fill an internal buffer, from which further  <code>read requests can inexpensively get their data (until the buffer
 * runs out).
 * <p>
